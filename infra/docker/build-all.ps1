...
Write-Host "Building Docker images for Zetnet microservices..." -ForegroundColor Green
...
Write-Host "Building Computer Service..." -ForegroundColor Yellow
...
Write-Host "Building Travel Service..." -ForegroundColor Yellow
...
Write-Host "Building Solutions Service..." -ForegroundColor Yellow
...
Write-Host "Building Enquiry Service..." -ForegroundColor Yellow
